...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  set -o pipefail && xcodebuild -scheme mailsync -configuration Release -destination 'generic/platform=macOS' ONLY_ACTIVE_ARCH=NO ARCHS="arm64 x86_64" CODE_SIGN_IDENTITY="-" CODE_SIGNING_REQUIRED=NO DEVELOPMENT_TEAM="" PROVISIONING_PROFILE_SPECIFIER="";
